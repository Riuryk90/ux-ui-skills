---
name: ux-ui-build
description: Design, build, or improve user-facing UI/UX, including interfaces, components, pages, forms, navigation, layouts, dashboards, landing/product pages, and responsive or interaction states. Use when a task asks how an interface should look, be structured, or behave for users, and when authorized implementation may be needed. Applies accessibility and ethical-UX criteria as part of construction. For pure critique without modification intent, use ux-ui-review.
---
